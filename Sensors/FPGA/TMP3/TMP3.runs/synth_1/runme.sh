...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/TMP3/TMP3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TMP3_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TMP3_wrapper.tcl

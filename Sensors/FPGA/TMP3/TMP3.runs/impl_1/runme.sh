...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/TMP3/TMP3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TMP3_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TMP3_wrapper.tcl -notrace

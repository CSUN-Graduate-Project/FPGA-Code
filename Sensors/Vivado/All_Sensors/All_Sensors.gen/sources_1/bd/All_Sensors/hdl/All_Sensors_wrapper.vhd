...
--Command     : generate_target All_Sensors_wrapper.bd
--Design      : All_Sensors_wrapper
...
end All_Sensors_wrapper;

architecture STRUCTURE of All_Sensors_wrapper is
  component All_Sensors is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
begin
All_Sensors_i: component All_Sensors
     port map (

...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/All_Sensors/All_Sensors.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log All_Sensors_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source All_Sensors_wrapper.tcl -notrace

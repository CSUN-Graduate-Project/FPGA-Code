...
HD_PWD='C:/Users/likea/Desktop/GradProject/github/FPGA-Code/Sensors/Vivado/All_Sensors/All_Sensors.runs/axi_cdma_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_cdma_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_cdma_0.tcl

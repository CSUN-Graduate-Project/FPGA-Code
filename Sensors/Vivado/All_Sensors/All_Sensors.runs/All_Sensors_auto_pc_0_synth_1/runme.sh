...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/All_Sensors/All_Sensors.runs/All_Sensors_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log All_Sensors_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source All_Sensors_auto_pc_0.tcl

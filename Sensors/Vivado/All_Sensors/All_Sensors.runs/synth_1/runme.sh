...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/All_Sensors/All_Sensors.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log All_Sensors_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source All_Sensors_wrapper.tcl

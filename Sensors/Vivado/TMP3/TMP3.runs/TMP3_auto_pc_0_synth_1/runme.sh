...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/TMP3/TMP3.runs/TMP3_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TMP3_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TMP3_auto_pc_0.tcl

...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/Heart_Rate/Heart_Rate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BPM_DDR_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BPM_DDR_wrapper.tcl

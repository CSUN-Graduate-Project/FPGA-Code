...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/Heart_Rate/Heart_Rate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BPM_DDR_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BPM_DDR_wrapper.tcl -notrace

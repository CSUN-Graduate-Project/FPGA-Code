...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/Heart_Rate/Heart_Rate.runs/Heart_Rate_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Heart_Rate_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Heart_Rate_processing_system7_0_0.tcl

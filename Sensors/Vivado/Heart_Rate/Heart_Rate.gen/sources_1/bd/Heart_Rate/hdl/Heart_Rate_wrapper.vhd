...
--Command     : generate_target Heart_Rate_wrapper.bd
--Design      : Heart_Rate_wrapper
...
end Heart_Rate_wrapper;

architecture STRUCTURE of Heart_Rate_wrapper is
  component Heart_Rate is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
begin
Heart_Rate_i: component Heart_Rate
     port map (

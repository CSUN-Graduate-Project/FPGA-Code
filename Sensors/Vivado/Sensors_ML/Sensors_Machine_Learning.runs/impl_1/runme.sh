...
HD_PWD='C:/Users/luisr/.Xilinx/VHDL_Projects/Graduate_Project/FPGA/Sensors_Machine_Learning/Sensors_Machine_Learning.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sensors_ML_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sensors_ML_wrapper.tcl -notrace

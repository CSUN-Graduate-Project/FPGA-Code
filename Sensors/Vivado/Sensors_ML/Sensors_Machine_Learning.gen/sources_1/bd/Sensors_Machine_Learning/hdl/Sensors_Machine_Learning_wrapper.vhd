...
--Command     : generate_target Sensors_Machine_Learning_wrapper.bd
--Design      : Sensors_Machine_Learning_wrapper
...
entity Sensors_Machine_Learning_wrapper is
  port (
...
end Sensors_Machine_Learning_wrapper;

architecture STRUCTURE of Sensors_Machine_Learning_wrapper is
  component Sensors_Machine_Learning is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
  ...
  end component Sensors_Machine_Learning;
  component IOBUF is
  port (
    I : in STD_LOGIC;
    O : out STD_LOGIC;
...
Sensors_Machine_Learning_i: component Sensors_Machine_Learning
     port map (

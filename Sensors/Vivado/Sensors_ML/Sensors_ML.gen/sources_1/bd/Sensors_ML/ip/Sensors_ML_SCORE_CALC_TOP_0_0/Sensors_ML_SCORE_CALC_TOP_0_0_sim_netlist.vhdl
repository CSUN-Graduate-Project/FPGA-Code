...
entity Sensors_ML_SCORE_CALC_TOP_0_0_DATA_PREP is
  port (
  ...
  attribute ORIG_REF_NAME of Sensors_ML_SCORE_CALC_TOP_0_0_DATA_PREP : entity is "DATA_PREP";
end Sensors_ML_SCORE_CALC_TOP_0_0_DATA_PREP;

architecture STRUCTURE of Sensors_ML_SCORE_CALC_TOP_0_0_DATA_PREP is
...
entity Sensors_ML_SCORE_CALC_TOP_0_0_SCORE_CALC is
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Sensors_ML_SCORE_CALC_TOP_0_0_SCORE_CALC : entity is "SCORE_CALC";
end Sensors_ML_SCORE_CALC_TOP_0_0_SCORE_CALC;

architecture STRUCTURE of Sensors_ML_SCORE_CALC_TOP_0_0_SCORE_CALC is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Sensors_ML_SCORE_CALC_TOP_0_0_SCORE_CALC_TOP is
  port (
    status : out STD_LOGIC_VECTOR ( 1 downto 0 );
    temp : in STD_LOGIC_VECTOR ( 13 downto 0 );
    clk : in STD_LOGIC;
...
end Sensors_ML_SCORE_CALC_TOP_0_0_SCORE_CALC_TOP;

architecture STRUCTURE of Sensors_ML_SCORE_CALC_TOP_0_0_SCORE_CALC_TOP is
...
DATA_PREP0: entity work.Sensors_ML_SCORE_CALC_TOP_0_0_DATA_PREP
     port map (
      ...
      \eda_out_reg[0]_0\(8) => DATA_PREP0_n_27,
      \eda_out_reg[0]_0\(7) => DATA_PREP0_n_28,
      \eda_out_reg[0]_0\(6) => DATA_PREP0_n_29,
      \eda_out_reg[0]_0\(5) => DATA_PREP0_n_30,
      \eda_out_reg[0]_0\(4) => DATA_PREP0_n_31,
      \eda_out_reg[0]_0\(3) => DATA_PREP0_n_32,
      \eda_out_reg[0]_0\(2) => DATA_PREP0_n_33,
      \eda_out_reg[0]_0\(1) => DATA_PREP0_n_34,
      \eda_out_reg[0]_0\(0) => DATA_PREP0_n_35,
      hr(13 downto 0) => hr(13 downto 0),
      \hr_out_reg[0]_0\(8) => DATA_PREP0_n_9,
      \hr_out_reg[0]_0\(7) => DATA_PREP0_n_10,
      \hr_out_reg[0]_0\(6) => DATA_PREP0_n_11,
      \hr_out_reg[0]_0\(5) => DATA_PREP0_n_12,
      \hr_out_reg[0]_0\(4) => DATA_PREP0_n_13,
      \hr_out_reg[0]_0\(3) => DATA_PREP0_n_14,
      \hr_out_reg[0]_0\(2) => DATA_PREP0_n_15,
      \hr_out_reg[0]_0\(1) => DATA_PREP0_n_16,
      \hr_out_reg[0]_0\(0) => DATA_PREP0_n_17,
      \hr_out_reg[0]_1\(8) => DATA_PREP0_n_36,
      \hr_out_reg[0]_1\(7) => DATA_PREP0_n_37,
      \hr_out_reg[0]_1\(6) => DATA_PREP0_n_38,
      \hr_out_reg[0]_1\(5) => DATA_PREP0_n_39,
      \hr_out_reg[0]_1\(4) => DATA_PREP0_n_40,
      \hr_out_reg[0]_1\(3) => DATA_PREP0_n_41,
      \hr_out_reg[0]_1\(2) => DATA_PREP0_n_42,
      \hr_out_reg[0]_1\(1) => DATA_PREP0_n_43,
      \hr_out_reg[0]_1\(0) => DATA_PREP0_n_44,
      \out\(8) => DATA_PREP0_n_0,
      \out\(7) => DATA_PREP0_n_1,
      \out\(6) => DATA_PREP0_n_2,
      \out\(5) => DATA_PREP0_n_3,
      \out\(4) => DATA_PREP0_n_4,
      \out\(3) => DATA_PREP0_n_5,
      ...
      \temp_out_reg[0]_0\(6) => DATA_PREP0_n_20,
      \temp_out_reg[0]_0\(5) => DATA_PREP0_n_21,
      \temp_out_reg[0]_0\(4) => DATA_PREP0_n_22,
      \temp_out_reg[0]_0\(3) => DATA_PREP0_n_23,
      \temp_out_reg[0]_0\(2) => DATA_PREP0_n_24,
      \temp_out_reg[0]_0\(1) => DATA_PREP0_n_25,
      \temp_out_reg[0]_0\(0) => DATA_PREP0_n_26,
      \temp_out_reg[0]_1\(8) => DATA_PREP0_n_45,
      \temp_out_reg[0]_1\(7) => DATA_PREP0_n_46,
      \temp_out_reg[0]_1\(6) => DATA_PREP0_n_47,
      \temp_out_reg[0]_1\(5) => DATA_PREP0_n_48,
      \temp_out_reg[0]_1\(4) => DATA_PREP0_n_49,
...
SCORE_CALC0: entity work.Sensors_ML_SCORE_CALC_TOP_0_0_SCORE_CALC
     port map (
      ...
      D(1) => DATA_PREP0_n_7,
      D(0) => DATA_PREP0_n_8,
      \P_EDA_S_reg[8]_0\(8) => DATA_PREP0_n_27,
      \P_EDA_S_reg[8]_0\(7) => DATA_PREP0_n_28,
      \P_EDA_S_reg[8]_0\(6) => DATA_PREP0_n_29,
      \P_EDA_S_reg[8]_0\(5) => DATA_PREP0_n_30,
      \P_EDA_S_reg[8]_0\(4) => DATA_PREP0_n_31,
      \P_EDA_S_reg[8]_0\(3) => DATA_PREP0_n_32,
      \P_EDA_S_reg[8]_0\(2) => DATA_PREP0_n_33,
      \P_EDA_S_reg[8]_0\(1) => DATA_PREP0_n_34,
      \P_EDA_S_reg[8]_0\(0) => DATA_PREP0_n_35,
      \P_HR_NS_reg[8]_0\(8) => DATA_PREP0_n_9,
      \P_HR_NS_reg[8]_0\(7) => DATA_PREP0_n_10,
      \P_HR_NS_reg[8]_0\(6) => DATA_PREP0_n_11,
      \P_HR_NS_reg[8]_0\(5) => DATA_PREP0_n_12,
      \P_HR_NS_reg[8]_0\(4) => DATA_PREP0_n_13,
      \P_HR_NS_reg[8]_0\(3) => DATA_PREP0_n_14,
      \P_HR_NS_reg[8]_0\(2) => DATA_PREP0_n_15,
      \P_HR_NS_reg[8]_0\(1) => DATA_PREP0_n_16,
      \P_HR_NS_reg[8]_0\(0) => DATA_PREP0_n_17,
      \P_HR_S_reg[8]_0\(8) => DATA_PREP0_n_36,
      \P_HR_S_reg[8]_0\(7) => DATA_PREP0_n_37,
      \P_HR_S_reg[8]_0\(6) => DATA_PREP0_n_38,
      \P_HR_S_reg[8]_0\(5) => DATA_PREP0_n_39,
      \P_HR_S_reg[8]_0\(4) => DATA_PREP0_n_40,
      \P_HR_S_reg[8]_0\(3) => DATA_PREP0_n_41,
      \P_HR_S_reg[8]_0\(2) => DATA_PREP0_n_42,
      \P_HR_S_reg[8]_0\(1) => DATA_PREP0_n_43,
      \P_HR_S_reg[8]_0\(0) => DATA_PREP0_n_44,
      \P_TEMP_NS_reg[8]_0\(8) => DATA_PREP0_n_18,
      \P_TEMP_NS_reg[8]_0\(7) => DATA_PREP0_n_19,
      \P_TEMP_NS_reg[8]_0\(6) => DATA_PREP0_n_20,
      \P_TEMP_NS_reg[8]_0\(5) => DATA_PREP0_n_21,
      \P_TEMP_NS_reg[8]_0\(4) => DATA_PREP0_n_22,
      \P_TEMP_NS_reg[8]_0\(3) => DATA_PREP0_n_23,
      \P_TEMP_NS_reg[8]_0\(2) => DATA_PREP0_n_24,
      \P_TEMP_NS_reg[8]_0\(1) => DATA_PREP0_n_25,
      \P_TEMP_NS_reg[8]_0\(0) => DATA_PREP0_n_26,
      \P_TEMP_S_reg[8]_0\(8) => DATA_PREP0_n_45,
      \P_TEMP_S_reg[8]_0\(7) => DATA_PREP0_n_46,
      \P_TEMP_S_reg[8]_0\(6) => DATA_PREP0_n_47,
      \P_TEMP_S_reg[8]_0\(5) => DATA_PREP0_n_48,
      \P_TEMP_S_reg[8]_0\(4) => DATA_PREP0_n_49,
      \P_TEMP_S_reg[8]_0\(3) => DATA_PREP0_n_50,
      \P_TEMP_S_reg[8]_0\(2) => DATA_PREP0_n_51,
      \P_TEMP_S_reg[8]_0\(1) => DATA_PREP0_n_52,
...
entity Sensors_ML_SCORE_CALC_TOP_0_0 is
  ...
  attribute NotValidForBitStream of Sensors_ML_SCORE_CALC_TOP_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Sensors_ML_SCORE_CALC_TOP_0_0 : entity is "Sensors_ML_SCORE_CALC_TOP_0_0,SCORE_CALC_TOP,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of Sensors_ML_SCORE_CALC_TOP_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of Sensors_ML_SCORE_CALC_TOP_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of Sensors_ML_SCORE_CALC_TOP_0_0 : entity is "SCORE_CALC_TOP,Vivado 2021.2";
end Sensors_ML_SCORE_CALC_TOP_0_0;

architecture STRUCTURE of Sensors_ML_SCORE_CALC_TOP_0_0 is
...
begin
U0: entity work.Sensors_ML_SCORE_CALC_TOP_0_0_SCORE_CALC_TOP
     port map (
      clk => clk,
      eda(13 downto 0) => eda(13 downto 0),
      hr(13 downto 0) => hr(13 downto 0),

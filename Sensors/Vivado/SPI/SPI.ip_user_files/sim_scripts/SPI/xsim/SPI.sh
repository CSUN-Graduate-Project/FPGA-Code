...
#
# Generated by Vivado on Tue Sep 20 20:37:26 -0700 2022
...
# Script info
echo -e "SPI.sh - Script generated by export_simulation (Vivado v2021.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L xilinx_vip -L secureip -L xpm --snapshot SPI xil_defaultlib.SPI -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim SPI -key {Behavioral:sim_1:Functional:SPI} -tclbatch cmd.tcl -protoinst "protoinst_files/SPI_Read.protoinst" -log simulate.log
}

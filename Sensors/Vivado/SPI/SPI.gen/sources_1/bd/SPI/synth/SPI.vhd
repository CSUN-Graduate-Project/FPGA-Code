...
entity SPI is
  ...
  attribute CORE_GENERATION_INFO of SPI : entity is "SPI,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=SPI,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of SPI : entity is "SPI.hwdef";
end SPI;

architecture STRUCTURE of SPI is
  component SPI_processing_system7_0_0 is
  port (
  ...
  end component SPI_processing_system7_0_0;
...
begin
  SPI0_MISO_I_0_1 <= spi_miso;
  spi_cs <= processing_system7_0_SPI0_SS_O;
  spi_mosi <= processing_system7_0_SPI0_MOSI_O;
  spi_sck <= processing_system7_0_SPI0_SCLK_O;
processing_system7_0: component SPI_processing_system7_0_0
     port map (

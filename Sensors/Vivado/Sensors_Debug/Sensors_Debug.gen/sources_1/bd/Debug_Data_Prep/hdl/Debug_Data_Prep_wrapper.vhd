...
--Command     : generate_target Debug_Data_Prep_wrapper.bd
--Design      : Debug_Data_Prep_wrapper
...
entity Debug_Data_Prep_wrapper is
  port (
...
end Debug_Data_Prep_wrapper;

architecture STRUCTURE of Debug_Data_Prep_wrapper is
  component Debug_Data_Prep is
  port (
    reset_rtl : in STD_LOGIC;
    sys_clock : in STD_LOGIC;
...
begin
Debug_Data_Prep_i: component Debug_Data_Prep
     port map (

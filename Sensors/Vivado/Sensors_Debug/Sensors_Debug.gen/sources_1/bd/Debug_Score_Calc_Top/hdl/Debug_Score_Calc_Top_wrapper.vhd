...
--Command     : generate_target Debug_Score_Calc_Top_wrapper.bd
--Design      : Debug_Score_Calc_Top_wrapper
...
entity Debug_Score_Calc_Top_wrapper is
  port (
...
end Debug_Score_Calc_Top_wrapper;

architecture STRUCTURE of Debug_Score_Calc_Top_wrapper is
  component Debug_Score_Calc_Top is
  port (
    reset_rtl : in STD_LOGIC;
    sys_clock : in STD_LOGIC;
  ...
  end component Debug_Score_Calc_Top;
  component IOBUF is
  port (
    I : in STD_LOGIC;
    O : out STD_LOGIC;
...
begin
Debug_Score_Calc_Top_i: component Debug_Score_Calc_Top
     port map (
